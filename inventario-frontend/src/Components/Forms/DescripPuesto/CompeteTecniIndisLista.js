...
export default function CompeteTecniIndisLista (props) {
 ...
 return (
  <div className="Secciòn_FuncionesDelPuesto">
   ...
   <textarea className='FuncionesDelPuesto_ObjetivoPuesto Responsabilidades_DescripcionInput' placeholder='Descripción de competencias técnicas indispensables'></textarea>   
   <h4 className='responsTitle'>Indispensable para ocupar la posición:</h4>
   <input type='text' className='Identificacion_CodigoDepar Anexos_NumInput' style={{'minWidth':'35%'}} placeholder='Competencia Indispensable para ocupar la posición'/>   
   <br/>   
   <br/>
   <br/>
   <fieldset>
    <input type='radio' id='Buen Dominio' name='formacionAcademica' value='Buen Dominio'/>
    <label for='Buen Dominio' style={{'margin':'0 0 0 8px'}}>Buen Dominio</label>
    <br/>
    <input type='radio' id='Dominio Básico' name='formacionAcademica' value='Dominio Básico'/>
    <label for='Dominio Básico' style={{'margin':'0 0 0 8px'}}>Dominio Básico</label>   
   </fieldset>   
