...
export default function HabilidadComputacion (props) {
 ...
 return (
  <div className="Secciòn_FuncionesDelPuesto">
   ...
   <input type='text' className='Identificacion_CodigoDepar Anexos_NumInput' placeholder='Programa Tecnológico'/> 
   <br/>
   <br/>
   <h4 className='responsTitle'>Grado:</h4>
   <select className='Identificacion_IDDepartamentoSelect Responsabilidades_IDPuestoSelect' required={true}>
   <option>A</option>
    <option>B</option>
    <option>C</option>
   </select>    
